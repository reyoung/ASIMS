...
"登录名称不能为空":255<a.length?"登录名称不能长于255字符":JSON.parse(d("byName/"+a))?"该登录名称已经存在":!0});return c=(c=(c=(c=(c=(c=c&&b.chk("Password",function(a){return 0==a.length?"密码不能为空":255<a.length?"密码不能超过255字符":!0}))&&b.chk("PasswordRepeat",function(a){return a!==$("#Password").val()?"两次输入的密码不一致":!0}))&&b.chk("Email",function(a){return g(a)?JSON.parse(d("byEmail/"+a))?"该邮箱已经存在":!0:"请输入正确格式的Email地址"}))&&b.chk("UserNumber",function(a){return 0===a.length?"工号不能为空":JSON.parse(d("byNumber/"+a))?"该工号已经存在":!0}))&&b.chk("Telephone",
e))&&b.chk("Mobile",e)})})});
